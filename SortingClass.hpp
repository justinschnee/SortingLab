...
SortingClass(int si); SortingClass();
...
// copy of either the in-order, reverse-order, or random array and sort it void insertionSort(int arr[]);
...
//the first sorted list, the index of the beginning (m), and the
//index of the last value in the second sorted list

void mergeSort(int arr[], int low, int hi); // this the array into of the second sorted list is the part that divides
